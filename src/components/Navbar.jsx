         ...
         <div className={`${open ? null : "hidden"} h-[19rem]`}>
          ...
          <div className="bg-gray-200/50 h-[1px] w-[85%] ml-[-10px]">
            <div className="flex cursor-pointer">
              ...
              <p className="my-auto ml-4 text-white font-semibold">Igbagbo</p>
              <p className="my-auto ml-2 text-white font-semibold">Olufiranye</p>
            </div>
            <p className="my-auto ml-[103px] mt-[-27px] text-xs font-light text-gray-200/60">
              iolufiranye@gmail.com
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <p className="mt-[25px] text-gray-100/30 text-sm">All Rights Reserved - KidCoder Soulutions</p>
          </div>
        </div>
      </nav>
