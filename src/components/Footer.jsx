...
import { FaSquareFacebook, FaInstagram, FaSquareXTwitter, FaGithub } from 'react-icons/fa6'
  ...
  return (
    ...
    <div className="sm:flex justify-between py-10 px-8 grid bg-gray-900">
      <div className="text-white">
        ...
        <p className="py-4">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elementum euismod fringilla.
         Praesent vehicula nunc a est iaculis, vitae pretium metus vehicula. Proin lacinia suscipit dui,
          in mattis dui efficitur vitae. Morbi maximus dui tellus, quis lobortis magna volutpat at. Vestibulum ac lacus dolor.
           Sed nisl urna, scelerisque vitae elementum ac, aliquet nec purus. Sed placerat, mauris at blandit suscipit, ligula
            ipsum vulputate est, sit amet tempor
            turpis elit sit amet leo. Morbi vel pretium purus.
        </p>
